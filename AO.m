...
%   y    = f(p)
%   e    = (data - y)                        ... 
%   F(p) = log evidence(e,y) - divergence(p) ... (c.f. Free Energy)
%
% the usage is:
...
while iterate
    ...
    % iterative descent on this trajectory
    %======================================================================
    while improve
    ...
    end  % end while improve... end descent on this trajectory
...
elseif search_method == 3
    dx    = x1 + (a.*J); % (Rasmussen w/ diff p steps)
elseif search_method == 4
    dx    = x1 + (a.*J);
end
