function  [beta,J,iter,cause,fullr,sse] = a_lm_fit_fe(X,V,y,model,options,maxiter)
...
[sse,iS,h] = objective(y,yfit,X,J',pp,iS,h);
...
function [sse,iS,h] = objective(Y,y,X,J,pp,iS,h)
...
[iS,nq,ipC,Cp,ihC,Ch,h,d] = hfun(Y,y,J,iS,h);
...
function [iS,nq,ipC,Cp,ihC,Ch,h,d] = hfun(Y,y,J,iS,h)
