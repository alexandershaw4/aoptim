...
%[X,F,CP] = AO(@fakeDM,p(:),c,DCM.xY.y,niter,12*4,[],1e-3);     % No precision
[X,F,CP] = AO(@fakeDM,p(:),c,DCM.xY.y,niter,12*4,DCM.xY.Q,1e-6,1e-12,0,2);  % MISO, 2nd order
%[X,F,CP]  = AO(@fakeDM,p(:),c,DCM.xY.y,niter,12*4,DCM.xY.Q,1e-6,1e-12,1,-1); % MIMO, complex 2nd order
