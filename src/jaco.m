function [j,ip,j1] = jaco(fun,x0,V,verbose,order,nout,params)
...
if nout ~= 1
    % for multi-output function differentiation, i.e. [J{:}]=f(x0)
    [j,ip,j1] = jaco_mimo(fun,x0,V,verbose,order,nout,params);
    return;
end
